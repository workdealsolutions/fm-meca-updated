...
const Sidebar = ({ 
  ...
  return (
    <>
      {isOpen && (
        <div 
          className={`mobile-overlay ${theme} ${isOpen ? 'visible' : ''}`}
          onClick={() => setIsOpen(false)}
        />
      )}
      <div className={`sidebar ${theme} ${isOpen ? 'mobile-visible' : ''} ${className || ''}`}>
        ...
        <button className={`close-mobile-menu ${theme}`} onClick={() => setIsOpen(false)}>×</button>
